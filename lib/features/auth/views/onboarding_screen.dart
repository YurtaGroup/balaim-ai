  ...
  Widget build(BuildContext context) {
    ...
    final pages = [
      ...
      _OnboardingPage(
        ...
        color: AppColors.primary,
        title: tr(lang,
            en: 'A real pediatrician, one tap away',
            ru: 'Настоящий педиатр в одно нажатие',
            ky: 'Чыныгы педиатр бир тийүүдө'),
        subtitle: tr(lang,
            en: 'When AI is not enough, get a paid async consult with a verified doctor. They reply within a day, usually with a head-start summary from Balam.',
            ru: 'Когда AI недостаточно — платная переписка с проверенным врачом. Отвечает в течение дня, видит сводку от Balam ещё до твоего сообщения.',
            ky: 'AI жетишсиз болсо — текшерилген дарыгер менен акылуу жазышуу. Бир күндө жооп берет, Balam даярдаган сводканы көрөт.'),
      ),
    ];
