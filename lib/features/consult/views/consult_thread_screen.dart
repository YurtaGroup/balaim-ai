...
class _ConsultThreadScreenState extends ConsumerState<ConsultThreadScreen> {
  ...
  bool _sending = false;
  bool _briefAnalyticsFired = false;
  ...
  void _sendFollowUp(String text) {
    ...
    unawaited(Analytics.instance
        .followUpPillTapped(consultId: widget.consultId));
      ...
      body: Column(
        children: [
          ...
          if (isDoctor && consult?.doctorBriefSummary != null) ...[
            Builder(builder: (_) {
              if (!_briefAnalyticsFired) {
                _briefAnalyticsFired = true;
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  unawaited(Analytics.instance
                      .doctorBriefViewed(consultId: widget.consultId));
                });
              }
              return _BriefCard(brief: consult!.doctorBriefSummary!, lang: lang);
            }),
          ],
          Expanded(
            child: messages.when(
